...
/**
 * blockchain_difficulty -  checks whether a given hash matches computes
 * the difficulty to assign to a potential next Block in the Blockchain
 * @blockchain: points to the Blockchain to analyze
 *
 * Return: the difficulty to be assigned to
...
same:	return (last_block->info.difficulty);
}
